...
public class ElasticsearchApiService {
  ...
  public ElasticsearchApiService(
      @Qualifier("elasticsearchServiceWebClient") WebClient elasticsearchServiceWebClient) {
   ...
   * @throws MicroserviceApiException error with specific message when calling elasticsearch
   *     microservice.
   */
  public void deleteEventsByTrainingInstanceId(Long trainingInstanceId) {
    try {
      ...
      throw new MicroserviceApiException(
          "Error when calling Elasticsearch API to delete events for particular instance (ID: "
              + trainingInstanceId
              + ").",
          ex);
    }
  ...
  public List<AbstractAuditPOJO> findAllEventsFromTrainingDefinition(Long trainingDefinitionId) {
    try {
      ...
      throw new MicroserviceApiException(
          "Error when calling Elasticsearch API for particular definition (ID: "
  ...
  public List<AbstractAuditPOJO> findAllEventsFromTrainingInstance(
    ...
    try {
      ...
      throw new MicroserviceApiException(
          "Error when calling Elasticsearch API for particular instance (ID: "
              + trainingInstance.getId()
              + ").",
          ex);
    }
  ...
  public List<AbstractAuditPOJO> findAllEventsFromTrainingRun(TrainingRun trainingRun) {
    try {
      ...
      throw new MicroserviceApiException(
          "Error when calling Elasticsearch API for particular run (ID: "
              + trainingRun.getId()
              + ").",
          ex);
    }
  ...
  public Map<Long, Map<Long, List<AbstractAuditPOJO>>> getAggregatedEventsByLevelsAndTrainingRuns(
    ...
    try {
      ...
      throw new MicroserviceApiException(
          "Error when calling Elasticsearch API for particular instance (ID: " + instanceId + ").",
          ex);
    }
  }
  ...
  /**
   * Obtain events from elasticsearch for particular training instance and level aggregated by
   * users.
   *
  ...
  public void deleteEventsFromTrainingRun(Long trainingInstanceId, Long trainingRunId) {
    try {
      ...
      throw new MicroserviceApiException(
          "Error when calling Elasticsearch API to delete events for particular training run (ID: "
              + trainingRunId
              + ").",
          ex);
    }
  ...
  public List<Map<String, Object>> findAllConsoleCommandsBySandbox(String sandboxId) {
    try {
      ...
      throw new MicroserviceApiException(
          "Error when calling Elasticsearch API for particular sandbox (ID: " + sandboxId + ").",
          ex);
    }
  }
  ...
  public List<Map<String, Object>> findAllConsoleCommandsByAccessTokenAndUserId(
    ...
    try {
      ...
      throw new MicroserviceApiException(
          "Error when calling Elasticsearch API for particular training "
              + "(access-token: "
              + accessToken
              + ")"
              + "(user: "
  ...
  public List<Map<String, Object>> findAllConsoleCommandsBySandboxAndTimeRange(
    ...
    try {
      ...
      throw new MicroserviceApiException(
          "Error when calling Elasticsearch API for particular commands of sandbox (ID: "
              + sandboxId
              + ").",
          ex);
    }
  ...
  public List<Map<String, Object>> findAllConsoleCommandsByAccessTokenAndUserIdAndTimeRange(
    ...
    try {
      ...
      throw new MicroserviceApiException(
          "Error when calling Elasticsearch API for particular commands of training "
              + "(access-token: "
              + accessToken
              + ")"
              + "(user: "
  ...
  public void deleteCommandsByPool(Long poolId) {
    try {
      ...
      throw new MicroserviceApiException(
          "Error when calling Elasticsearch API to delete bash commands for particular pool (ID: "
              + poolId
              + ").",
          ex);
    }
  ...
  public void deleteCommandsByAccessToken(String accessToken) {
    try {
      ...
      throw new MicroserviceApiException(
          "Error when calling Elasticsearch API to delete bash commands for particular training instance (access-token: "
              + accessToken
              + ").",
          ex);
    }
  ...
  public void deleteCommandsBySandbox(String sandboxId) {
    try {
      ...
      throw new MicroserviceApiException(
          "Error when calling Elasticsearch API to delete bash commands for particular sandbox (ID: "
              + sandboxId
              + ").",
          ex);
    }
  ...
  public void deleteCommandsByAccessTokenAndUserId(String accessToken, Long userId) {
    try {
      ...
      throw new MicroserviceApiException(
          "Error when calling Elasticsearch API to delete bash commands for particular training (Access Token: "
              + accessToken
              + ", User ID: "
              + userId
              + ").",
